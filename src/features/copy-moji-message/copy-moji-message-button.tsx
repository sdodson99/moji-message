...
export function CopyMojiMessageButton({
  mojiMessage,
  ...
  const onCopyMojiMessage = () => {
    ...
    const mojiMessageWithMarketingSuffx =
      createMojiMessageWithMarketingSuffix(mojiMessage);
